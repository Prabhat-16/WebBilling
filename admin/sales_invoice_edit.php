<?php
    ...
    if(!isset($_GET['id']))
    {
        echo "<script>window.location = 'view_sales_invoice.php';</script>";
    }
    else
    {
        $sql_view = "SELECT * FROM tbl_sales_invoice WHERE sales_invoice_id = '".$_GET['id']."'";
        ...
        $sql_detail_view = "SELECT * FROM tbl_sales_invoice_detail WHERE sales_invoice_id = '".$_GET['id']."'";
        ...
        $invoiceNumberQuery = "Select invoice_no FROM tbl_sales_invoice WHERE sales_invoice_id  = '".$_GET['id']."'";
        ...
        $description = 'Sales:Invoice_no:'.$invoice_no;

        if(isset($_POST['BtnInvoice']))
        {
            // echo "Clicked";
            //Update Code For Purchase Invoice
        $sql_sales_invoice_update = "UPDATE tbl_sales_invoice SET party_id = '".$_POST['party_name']."'  ,due_days = '".$_POST['credit_period']."' , sales_date = '".$_POST['invoice_date']."' , due_date = '".$_POST['due_date']."' , narration  = '".$_POST['narration']."', net_total = '".$_POST['sub_total']."' , discount = '".$_POST['discount_total']."' , pay = '".$_POST['pay']."' , place_of_supply_id = '".$_POST['state']."' , payment_type_id = '".$_POST['payment_type']."' , financial_year_id = '".$financial_year."' , created_by = '".$_SESSION['user_id']."' WHERE sales_invoice_id  = '".$_GET['id']."'";
        $rs_sales_invoice_update = mysqli_query($con,$sql_sales_invoice_update);
        if(!$rs_sales_invoice_update)
        {
            die('Sales Invoice Not Updated.'.mysqli_error($con));
        }
        ...
        if ($number > 0) {
            if (isset($_POST['sales_invoice_detail_id'])) {
                 implode(",", $_POST['sales_invoice_detail_id']);
            }

            for ($i = 0; $i < $number; $i++) 
            {

                 $_POST['sales_invoice_detail_id'][$i];
                if ($_POST['sales_invoice_detail_id'][$i] ==  0) {
                    $sql_sales_invoice_detail_update = "INSERT INTO tbl_sales_invoice_detail(sales_invoice_id,product_id,qty,rate,discount_per,discount_amt,gst_per,gst_amt,financial_year_id) VALUE ('" . $_GET['id'] . "','" . $_POST['product_id'][$i] . "','" . $_POST['quantity'][$i] . "','" . $_POST['rate'][$i] . "','" . $_POST['discount_per'][$i] . "','" . $_POST['discount_amt'][$i] . "','" . $_POST['gst_per'][$i] . "','" . $_POST['gst_amt'][$i] . "','" . $financial_year . "')";
                } else 
                {
                    // Update Code For Cash Memo Detail
                    $sql_sales_invoice_detail_update = "UPDATE tbl_sales_invoice_detail SET  product_id = '" . $_POST['product_id'][$i] . "' , qty = '" . $_POST['quantity'][$i] . "' , rate = '" . $_POST['rate'][$i] . "' , discount_per = '" . $_POST['discount_per'][$i] . "' , discount_amt = '" . $_POST['discount_amt'][$i] . "' , gst_per = '" . $_POST['gst_per'][$i] . "' , gst_amt = '" . $_POST['gst_amt'][$i] . "' , financial_year_id = '" . $financial_year . "' WHERE sales_invoice_detail_id  = '" . $_POST['sales_invoice_detail_id'][$i] . "' ";
                    // echo $sql_purchase_invoice_detail_update ;
                }

                $rs_sales_detail_update = mysqli_query($con, $sql_sales_invoice_detail_update);
                if (!$rs_sales_detail_update) 
                {
                    die('Sales Detail Not Updated.'.mysqli_error($con));
                }
            }
             //Update Code For Company Ledger
             $sql_company_ledger_update = "UPDATE tbl_company_ledger SET  description = '".$description."' , credit = '".$_POST['pay']."' , debit = '0.00' , company_ledger_date = '".$_POST['invoice_date']."' , financial_year_id = '".$financial_year."' WHERE related_id = '".$_POST['sales_invoice_id']."' AND related_obj = 'SO'";
            //  echo $sql_company_ledger_update;
             $rs_company_ledger_update = mysqli_query($con,$sql_company_ledger_update);
             if(!$rs_company_ledger_update)
             {
                 die('Company Ledger Not Updated.'.mysqli_error($con));
             }

             //Update Code For Party Ledger
             $sql_party_ledger = "UPDATE tbl_party_ledger SET party_type = 'Customer' , party_id = '".$_POST['party_name']."' , invoice_type = '0' ,  narration = '".$description."' , credit = '".$_POST['pay']."' ,debit = '0.00' , party_ledger_date = '".$_POST['invoice_date']."' , financial_year_id = '".$financial_year."' , created_by = '".$_SESSION['user_id']."' WHERE related_id = '".$_POST['sales_invoice_id']."'AND related_obj_name = 'SO' ";
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <div class="card-header-lg">
                    ...
                    <div class="text-end">
                        <a href="view_sales_invoice.php" class="btn btn-light">View Invoice</a>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="field-wrapper">
                                            <select class="select-single js-states" title="Select Term" data-live-search="true" name="party_name" id="party_name">
                                                ...
                                                <?php
                                                $sql_party_type = "SELECT * FROM tbl_party WHERE party_type = 'Customer'";
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="field-wrapper">
                                            <div class="input-group">
                                                <input type="date" class="form-control " name="invoice_date" id="invoice_date"  value="<?php echo $row_view['sales_date']; ?>">
                                        ...
                                        <tbody id="dynamic_field">
                                            ...
                                            <tr class="static-row" id="row0">
                                                <td>
                                                    ...
                                                    <input type="hidden" name="sales_invoice_detail_id[]" id="sales_invoice_detail_id" value="<?php echo $row_detail_view['sales_invoice_detail_id']; ?>">
                                                        <select class="" id="product_id" name="product_id[]" >
                                                ...
                                                <td>
                                                    ...
                                                    <div class="field-wrapper m-0">
                                                        <div class="input-group">
                                                            <input type="number" class="form-control amount" placeholder="0.00" name="amount[]" value="<?php echo $amount; ?>" id="amount" readonly>
                                                        </div>
                                                    </div>
                                                    <!-- Field wrapper end -->
                                                </td>
                                                <td>
                                                    <div class="table-actions">
                                                        <a href="#" class="btn btn-light btn-delete" id="<?php echo $row_detail_view['sales_invoice_detail_id']; ?>" name="BtnDelete">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        ...
                                                        <div class="field-wrapper">
                                                            <div class="input-group">
                                                                <input class="form-control" readonly type="number" name="sub_total" value="<?php echo $row_view['net_total']; ?>" id="sub_total" placeholder="0.00">
                                                            </div>
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-actions-footer">
                                    <div class="text-end">
                                        <input type="hidden" name="sales_invoice_id" id="sales_invoice_id" value="<?php echo $row_view['sales_invoice_id'] ?>" />
...
<script>
    $(document).ready(function() 
    {
        ...
        event.preventDefault();
        var sales_invoice_detail_id  = $(this).attr("id");
       
            if (confirm("Are you Sure you Want to Delete this?")) {
                $.ajax({
                    url: 'sales_invoice_detail_delete.php',
                    data: {
                        'id': sales_invoice_detail_id ,
                        'delete': 1
                    },
                    type: 'post',
