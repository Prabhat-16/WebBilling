	...
	<div class="row gutters">
		<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
			<div class="stats-tile">
				...
				<div class="sale-details">
					<?php
							$sql_count_product = "SELECT COUNT(*) as product_count FROM tbl_item";
							$rs_count_product = mysqli_query($con,$sql_count_product);
							if(!$rs_count_product)
							{
								die('No Product Found.'.mysqli_error($con));
							}
							$row_product_count = mysqli_fetch_array($rs_count_product);
					?>
					<h2><?php echo $row_product_count['product_count']; ?></h2>
					<p>Products</p>
				</div>
		...
		<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
			<div class="stats-tile">
				...
				<div class="sale-details">
					<?php
						$sql_count_supplier = "SELECT COUNT(*) as supplier_count FROM tbl_party WHERE party_type = 'Supplier'";
						$rs_count_supplier = mysqli_query($con,$sql_count_supplier);
						if(!$rs_count_supplier)
						{
							die('No Supplier Found.'.mysqli_error($con));
						}
						$row_supplier_count = mysqli_fetch_array($rs_count_supplier);
					?>
					<h2><?php echo $row_supplier_count['supplier_count']; ?></h2>
					<p>Suppliers</p>
				</div>
				<div class="sale-graph">
		...
		<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
			<div class="stats-tile">
				...
				<div class="sale-details">
					<?php
						$sql_count_customer = "SELECT COUNT(*) as customer_count FROM tbl_party WHERE party_type =  'Customer' ";
						$rs_count_customer = mysqli_query($con,$sql_count_customer);
						if(!$rs_count_customer)
						{
							die('No Customer Found.'.mysqli_error($con));
						}
						$row_customer_count = mysqli_fetch_array($rs_count_customer);
					?>
					<h2><?php echo $row_customer_count['customer_count']; ?></h2>
					<p>Customers</p>
				</div>
				<div class="sale-graph">
