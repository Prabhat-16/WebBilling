...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 27, 2024 at 07:13 AM
...
(5, 9, 'Income', 'Income Goodwill Recived by Last King', '45000', '0.00', '2024-02-14', 2),
(7, 48, 'Expense', 'Expense For Employee Tea', '0.00', '1500', '2024-02-14', 2),
(8, 10, 'Income', 'Income Sales To Prabhat Mishra a', '45000', '0.00', '2024-02-02', 2),
(9, 49, 'Expense', 'Expense holding for Adv', '0.00', '8500', '2024-02-10', 2),
(10, 11, 'Income', 'Income Sales Of Furniture To XYZ ', '45000', '0.00', '2024-02-19', 2),
(12, 6, 'Purchase', 'Testing For 3 Tables For Eah', '0.00', '5000', '2024-02-27', 2),
(13, 7, 'Purchase', '', '0.00', '', '2024-02-27', 2);
...
(1, 'Supplier', 24, 4, 'PO', 0, 4, 'Testing For Both Purchase And Party Ledger', '0.00', '2000', '2024-02-27', 2, 4),
(2, 'Supplier', 4, 5, 'PO', 0, 5, 'Testing To Deep For Both Table', '0.00', '10000', '2024-02-27', 2, 4),
(3, 'Supplier', 1, 6, 'PO', 0, 6, 'Testing For 3 Tables For Eah', '0.00', '5000', '2024-02-27', 2, 4),
(4, 'Supplier', 0, 7, 'PO', 0, 7, '', '0.00', '', '2024-02-27', 2, 4);
...
INSERT INTO `tbl_purchase_invoice` (`purchase_invoice_id`, `party_id`, `ref_order_no`, `invoice_no`, `purchase_date`, `narration`, `sub_total`, `discount`, `pay`, `place_of_supply_id`, `payment_type_id`, `financial_year_id`, `created_by`, `added_date`) VALUES
(1, 1, 0, 1, '2024-02-26', 'Testing', 1010.00, 10.00, 100, 1, 4, 2, 4, '2024-02-26 10:20:58'),
(2, 24, 12345, 2, '2024-02-26', 'Testing For Meet', 9.00, 0.70, 100, 4, 4, 2, 4, '2024-02-26 10:22:24'),
(3, 4, 745632, 3, '2024-02-26', 'Testing for Deep', 20.00, 0.20, 19, 6, 6, 2, 4, '2024-02-26 10:23:41'),
(4, 24, 1010, 4, '2024-02-27', 'Testing For Both Purchase And Party Ledger', 201.88, 4.00, 2000, 6, 6, 2, 4, '2024-02-27 05:06:52'),
(5, 4, 7890, 5, '2024-02-27', 'Testing To Deep For Both Table', 242.26, 4.80, 10000, 5, 4, 2, 4, '2024-02-27 05:10:40'),
(6, 1, 7410, 6, '2024-02-27', 'Testing For 3 Tables For Eah', 19380.00, 1000.00, 5000, 2, 11, 2, 4, '2024-02-27 05:21:55'),
(7, 0, 0, 7, '2024-02-27', '', 0.00, 0.00, 0, 0, 0, 2, 4, '2024-02-27 06:36:53');
...
CREATE TABLE IF NOT EXISTS `tbl_purchase_invoice_detail` (
  ...
  `igst_per` varchar(20) NOT NULL,
  `igst_amt` bigint NOT NULL,
  `sgst_per` varchar(20) NOT NULL,
  `sgst_amt` bigint NOT NULL,
  `cgst_per` varchar(20) NOT NULL,
  `cgst_amt` bigint NOT NULL,
  `financial_year_id` bigint NOT NULL,
