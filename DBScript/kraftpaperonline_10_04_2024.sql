...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 10, 2024 at 06:34 AM
...
) ENGINE=MyISAM AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci;
...
) ENGINE=MyISAM AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `tbl_cash_memo_return` (
  ...
  `customer_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL,
  `mobile_no` bigint NOT NULL,
  `invoice_no` bigint NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `tbl_category` (
  ...
  `category_code` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_company` (
  ...
  `company_logo` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `signature` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `tbl_company_ledger` (
  ...
  `related_obj` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_driver` (
  ...
  `driver_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_expense` (
  ...
  `expense_description` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `expense_photo` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `payment_type_id` bigint NOT NULL,
  `financial_year_id` bigint NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `tbl_expense_type` (
  ...
  `expense_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `created_by` bigint NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `tbl_financial_year` (
  ...
  `financial_year` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_gsm` (
  ...
  `gsm_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `created_by` bigint NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`gsm_id`),
...
CREATE TABLE IF NOT EXISTS `tbl_gst_slab` (
  ...
  `gst_slab_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_income` (
  ...
  `income_description` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `income_photo` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `payment_type_id` bigint NOT NULL,
  `financial_year_id` bigint NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `tbl_income_type` (
  ...
  `income_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `created_by` bigint NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `tbl_item` (
  ...
  `size_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL,
  ...
  `is_active` tinyint(1) NOT NULL,
  `item_photo` varchar(2000) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL,
  `created_by` bigint NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`item_id`),
  UNIQUE KEY `item_name` (`item_name`)
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `tbl_party` (
  ...
  `party_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `party_type` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `contact_no` bigint NOT NULL,
  `email` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `op_balance` varchar(7) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `address` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `discount` decimal(18,2) NOT NULL,
  `state_id` bigint NOT NULL,
  `gstin` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_party_ledger` (
  ...
  `invoice_no` bigint NOT NULL,
  `narration` varchar(500) CHARACTER SET utf8 COLLATE utf8_0900_ai_ci NOT NULL,
  `credit` decimal(18,2) NOT NULL,
  `debit` decimal(18,2) NOT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci;
...
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `tbl_quality` (
  ...
  `quality_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `created_by` bigint NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `tbl_size` (
  ...
  `size_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` bigint NOT NULL,
  PRIMARY KEY (`size_id`),
...
CREATE TABLE IF NOT EXISTS `tbl_transport` (
  ...
  `vehicle_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `vehicle_no` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `is_active` tinyint(1) NOT NULL,
  `created_by` bigint NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `tbl_user` (
  ...
  `user_profile` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `added_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` bigint NOT NULL,
  PRIMARY KEY (`user_id`),
...
(4, 'Prabhat Mishra', 'mprabhat846@gmail.com', 7874063236, 'prabhat', '$2y$10$oRegkP5iaBcV0/m4jSgJOOXdUGj2D9zejXNZaCQkxgkaRwW.vBq4G', 1, 0, 'wallpapersden.com_satoru-gojo-cool-jujutsu-kaisen-hd_1920x1080.jpg', '2024-01-09 09:58:10', 4),
