...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 18, 2024 at 04:44 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertItem` (IN `INAME` VARCHAR(30), IN `QID` BIGINT(20), IN `CID` BIGINT(20), IN `SID` VARCHAR(100), IN `GID` VARCHAR(100), IN `QTY` BIGINT(50), IN `AMT` BIGINT(100), IN `OPSTOCK` BIGINT(50), IN `PTY` BIGINT(50), IN `CTP` DATE, IN `ISACTIVE` TINYINT(1), IN `ITEMPHOTO` VARCHAR(2000), IN `UID` BIGINT(20))   BEGIN
	INSERT INTO tbl_item (item_name,quality_id,category_id,size_id,gsm_id,quantity,amount,op_stock,penalty,credit_period,is_active,item_photo,created_by) VALUE (INAME,QID,CID,SID,GID,QTY,AMT,OPSTOCK,PTY,CTP,ISACTIVE,ITEMPHOTO,UID);
END$$
...
(92, '784QWE', 'NEW', 1, 4, '2024-02-12 12:18:47');
...
(8, 10, 'Income', 'Income Sales To Prabhat Mishra', '45000', '0.00', '2024-02-02', 2),
...
(10, 2, 2, '2024-02-02', 45000, 'Sales To Prabhat Mishra', '', 6, 2, '2024-02-16 07:08:36');
...
(1, 'Kraft Paper', 3, 90, '3,4', '1,3', 52, 4500, 456, 10, '2024-02-01', 0, '', 4, '2024-02-12 12:16:20'),
(20, 'nfvnfek', 8, 8, '3,4,7', '1,3,8', 520, 456, 85, 46545, '2024-02-09', 1, '', 4, '2024-02-16 06:24:12');
...
(1, 'TRYON INFOSOFT', 'tryoninfosoft@gmail.com', 7410236589, 'admin', '$2y$10$qmEDT.KH6ZmQqJ6rggLZdeXttmzc2miSeNh9woixKeMeINVhySCBm', 1, 0, '1631333733870.jpg', '2024-02-17 17:10:24', 4),
(4, 'Prabhat Mishra', 'mprabhat@gmail.com', 7874063236, 'prabhat', '$2y$10$P5prKWh0uhKDxv0xNRy1cukIPiYpGSXN9ONwt6EcGxw64lvaaeU4a', 1, 0, 'wallpapersden.com_satoru-gojo-cool-jujutsu-kaisen-hd_1920x1080.jpg', '2024-01-09 09:58:10', 4),
(57, 'Deep Pandya', 'deep@gmail.com', 6325874125, 'deep', '$2y$10$aXKW/Q99/8RXHRKgmWJoouBzq2ECR.iCiK866Bacishm89UU/.aWa', 0, 0, 'pexels-cesar-perez-733745.jpg', '2024-02-17 17:24:29', 4);
COMMIT;
