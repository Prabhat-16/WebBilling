...
WHERE ti.financial_year_id = (SELECT financial_year_id FROM tbl_financial_year WHERE is_default = 1)
	ORDER BY income_invoice_no DESC;
END$$
...
(68, 26, 'PO', 'Purchase:Invoice_no:5', 0.00, 872500.00, '2024-04-16', 2);
...
(29, 'Supplier', 24, 26, 'PO', 0, 5, 'Purchase:Invoice_no:5', 0.00, 872500.00, '2024-04-16', 2, 4);
...
(26, 24, '005', 5, 20, '2024-04-16', '2024-05-06', 'Taken Goods For Sales Another', 921875.00, 21750.00, 872500.00, 3, 4, 2, 4),
...
(46, 26, 21, 100.00, 1500.00, 10.00, 15000.00, 18.00, 24300.00, 2),
(47, 26, 24, 50.00, 500.00, 0.00, 0.00, 10.00, 2500.00, 2),
(48, 26, 1, 150.00, 4500.00, 1.00, 6750.00, 10.00, 66825.00, 2);
...
(4, 'Prabhat Mishra', 'mprabhat846@gmail.com', 7874063236, 'prabhat', '$2y$10$oRegkP5iaBcV0/m4jSgJOOXdUGj2D9zejXNZaCQkxgkaRwW.vBq4G', 1, 0, '11863.jpg', '2024-01-09 09:58:10', 4),
